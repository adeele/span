    ...
    public static void main(String[] args) throws Exception {
        ...
        if (cmd.hasOption("file") || cmd.hasOption("f")) {
            ...
            if (cmd.hasOption("directory") || cmd.hasOption("d")) {
                file = new File(cmd.getOptionValue("directory"));
                ...
                // TODO: handle directory option; TOREMOVE: return
                return;
            } else {
                return;
            }
        ...
        ReportGenerator raport = new ReportGenerator(listener.getIssues(), file.getName(), output);
    }
}
